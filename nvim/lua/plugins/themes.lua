    ...
    opts = function(_, opts)
      ...
      return vim.tbl_deep_extend("force", opts, {
        ...
        highlight_groups = {
          ...
          -- DiffDelete = { fg = "love" },
          DiffAdd = { bg = colors.emerald },
          DiffDelete = { bg = "love" },
          DiffChange = { blend = 10 },
          DiffText = { link = "DiffChange" },
          -- DiffText = { bg = "#433842" },
          -- DiffAdd = { fg = colors.emerald, inherit = false },
          -- DiffDelete = { fg = "love", inherit = false },
          -- DiffChange = { link = "DiffAdd" },
          -- DiffText = { link = "DiffAdd" },
          -- DiffAdd = { fg = colors.emerald },
          -- DiffDelete = { fg = "love" },
          -- DiffAdd = { fg = colors.emerald, bg = "none", blend = 10 },
          -- DiffDelete = { fg = "love", bg = "none", blend = 10 },
          -- DiffAdd = { fg = colors.emerald, bg = colors.bg, blend = "none" },
          -- DiffDelete = { fg = "love", bg = colors.bg, blend = "none" },
          -- DiffText = { fg = "iris", inherit = false },
          -- DiffChange = { fg = "iris", inherit = false },
          -- DiffChange = { inherit = false },
          -- DiffText = { link = "DiffAdd" },
          -- DiffChange = { link = "DiffAdd" },
