...
alias gl='git log --pretty="format:%C(auto)%h%d %s %C(dim blue)(%ar)" --date="format:%Y-%m-%d %H:%M:%S"'
...
alias gll='git log --pretty="format:%C(auto)%h%d %s %C(dim blue)(%ar) %ad %an %ae" --date="format:%Y-%m-%d %H:%M:%S"'
